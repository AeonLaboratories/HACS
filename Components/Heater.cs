...
{
	public class Heater : HacsComponent
	{
		#region Component Implementation

		public static readonly new List<Heater> List = new List<Heater>();
		public static new Heater Find(string name) { return List.Find(x => x?.Name == name); }
		...
		public enum Devices { CFFurnace, VTC, VTC_WARM, HT470  }
		...
		[XmlIgnore] public Devices DeviceType { get; private set; }
		[XmlIgnore] public Modes Mode { get; private set; }
		...
		public bool IsOn => Mode != Modes.Off;
