...
{
	public class VTT : HacsComponent
	{
		#region Component Implementation

		public static readonly new List<VTT> List = new List<VTT>();
		public static new VTT Find(string name) { return List.Find(x => x?.Name == name); }
